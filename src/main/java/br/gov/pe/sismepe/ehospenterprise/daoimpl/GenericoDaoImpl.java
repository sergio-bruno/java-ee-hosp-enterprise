...
public class GenericoDaoImpl<T, K> implements GenericoDao<T, K> {
	...
	public GenericoDaoImpl(Class<T> classeDaEntidade, EntityManager entityManger) {
	...
	public List<T> listarTodos(){
		return entityManager.createQuery("select t from " + classeDaEntidade.getSimpleName() + " t",classeDaEntidade).
				getResultList();
	}
